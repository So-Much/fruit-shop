        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <div className="mb-4 flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-white">Farm Fresh</span>
            </div>
            <p className="mb-4 text-sm">
              Your trusted source for fresh, quality fruits delivered daily.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/ordering" className="transition-colors hover:text-white">
                  Products
                </Link>
              </li>
              <li>
                <a href="#combos" className="transition-colors hover:text-white">
                  Combos
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>Hotline: <a href="tel:+1234567890" className="text-green-400 hover:text-green-300">+1 (234) 567-890</a></span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="mt-0.5 h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>Email: <a href="mailto:hello@farmfresh.com" className="text-green-400 hover:text-green-300">hello@farmfresh.com</a></span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="mt-0.5 h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>123 Farm Street, Fresh City, FC 12345</span>
              </li>
            </ul>
          </div>
        </div>
